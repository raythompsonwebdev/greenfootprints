          ...
          <ul className="slides">
            ...
            <li className="sliders">
              <div className="slider-caption">
                <h1>Recycling</h1>
                <p>Award winning recycling website. Voted best recyling website 2010 and 2012</p>
                <a href="#recycling" title="link to recycling"
                  className="largeButton homeBgColor">Read More</a>
              </div>
              <img id="sliderOneImg" alt="recycling-advice-green-foot-prints-com" src="./images/slider/slider-image2-greenfootprints-com.png"/>
            ...
            <li className="sliders">
              <div className="slider-caption">
                ...
                <p>There are three key factors when thinking about how to recycle &apos; The 3 R&apos;s:</p>
                <a href="#recycling-facts" title="link to recycling facts"
                  className="largeButton homeBgColor">Read
                  More</a>
              </div>
              <img id="sliderTwoImg" src="./images/slider/slider-image3-greenfootprints-com.png" alt="recycling-advice-green-foot-prints-com" />
            </li>

            <li className="sliders">
              <div className="slider-caption">
                <h1>Recycling Different Materials</h1>
                <p>You can find out how to recycle different materials such as Glass, Batteries and
                  Mobile Phones by simply using our list by clicking button below</p>
                <a href="#ten-ways" title="link to ten ways to recycling"
                  className="largeButton homeBgColor">Read
                  More</a>
              </div>
              <img id="sliderThreeImg" src="./images/slider/slider-image4-greenfootprints-com.png" alt="recycling-advice-green-foot-prints-com" />
            </li>
