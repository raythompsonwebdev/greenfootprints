...
function Footer() {
  ...
  return (
    ...
    <footer>
      <ul>
     <li><Link to="/" className="nav-links" title="Home page">Home</Link></li>
     <li>
     ...
     <li>
      <Link to="/collections" className="nav-links" title="Recycling collection page"
       >Collections</Link>
     </li>
     <li>
     ...
     <li>
      <Link to="/contact" className="nav-links" title="Contact page">Contact</Link>
     </li>
    </ul>
    </footer>
