import imageBinImg from '../images/webp/Image-bin.webp';
import recyclingBinImg from '../images/webp/recylingbins-greenfootprints-com.webp';
import leafRoofHouse from '../images/webp/house-greenfootprints-com.webp';

const collectionData = [
  {
    id: 1,
    title: 'Recycling and rubbish bin in a German railway station.',
    text: 'A number of different systems have been implemented to collect recyclates from the general waste stream. These systems lie along the spectrum of trade-off between public convenience and government ease and expense. The three main categories of collection are "drop-off centres", "buy-back centres" and "curbside collection".',
    image: imageBinImg,
  ...
  },
  {
    id: 7,
    title: 'Early sorting of recyclable materials..',
    text: 'Next, automated machinery separates the recyclates by weight, splitting lighter paper and plastic from heavier glass and metal. Cardboard is removed from the mixed paper, and the most common types of plastic, PET (#1) and HDPE (#2), are collected. This separation is usually done by hand, but has become automated in some sorting centers: a spectroscopic scanner is used to differentiate between different types of paper and plastic based on the absorbed wavelengths, and subsequently divert each material into the proper collection channel. Strong magnets are used to separate out ferrous metals, such as iron, steel, and tin-plated steel cans ("tin cans"). Non-ferrous metals are ejected by magnetic eddy currents in which a rotating magnetic field induces an electric current around the aluminium cans, which in turn creates a magnetic eddy current inside the cans. This magnetic eddy current is repulsed by a large magnetic field, and the cans are ejected from the rest of the recyclate stream. Finally, glass must be sorted by hand based on its color: brown, amber, green or clear.',
    image: imageBinImg,
    alt: 'recylingbins-image-green-foot-prints-com',
  },
  {
