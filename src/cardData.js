// import paperbottle from './static/images/gif/recyling-guide.gif';

const cardData = [
  {
    id: 1,
    imageName: 'paper-bottles',
    imageUrl: '/images/gif/recyling-guide.gif',
  ...
  },
  {
    ...
    imageUrl: '/images/gif/recycling-flowchart.gif',
    alt: 'recycling-advice-green-foot-prints-com',
    imageId: 'flow-chart',
    downloadlink:
  ...
  },
  {
    ...
    imageUrl: '/images/gif/wordsearch.gif',
    alt: 'recycling-advice-green-foot-prints-com',
    imageId: 'word-search',
    downloadlink:
